...
class AdminAddBranchScreen extends StatefulWidget {
  const AdminAddBranchScreen({
    super.key,
  });

  @override
  State<AdminAddBranchScreen> createState() =>
      _AdminAddBranchScreenState();
}

class _AdminAddBranchScreenState
    extends State<AdminAddBranchScreen> {
  // ============================================================
  // CONTROLLERS
  // ============================================================
  ...
  Widget _buildPageHeader() {
    return Column(
      ...
      children: [
        ...
        Text(
          'Add a pickup and return location for your rental business.',
          style: GoogleFonts.manrope(
            fontSize: 12,
            height: 1.45,
      ...
      child: Column(
        ...
        children: [
          ...
          _buildField(
            ...
            label: 'Full address',
            hint:
                'Enter complete pickup / return address',
              ...
              children: [
                ...
                Text(
                  _isActive
                      ...
                      : 'This branch will remain unavailable for bookings.',
                  style: GoogleFonts.manrope(
                    fontSize: 10.5,
                    height: 1.35,
                    fontWeight: FontWeight.w500,
  ...
  Future<void> _saveBranch() async {
    ...
    if (tenantId.isEmpty) {
      _showError(
        'Tenant configuration is missing. Unable to create branch.',
      );
      return;
    }
    ...
    try {
      ...
      await BranchService.instance.createBranch(
        tenantId: tenantId,
        branch: branch,
      );
